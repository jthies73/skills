...
- **Default to cutting**: every edit aims to end shorter than it started. Add a line only when the document cannot do its job without it, and pay for it by finding one to remove.
