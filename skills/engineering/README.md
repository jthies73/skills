...
- **[implement](./implement/SKILL.md)**: Build the work described by a spec or a Deliverable's Subtasks on a branch and worktree of its own, driving `/tdd` at pre-agreed seams and closing out with `/code-review`, leaving the commit to `/land-the-work`.
...
- **[land-the-work](./land-the-work/SKILL.md)**: Commit each finished slice as a Conventional Commit on the Deliverable's branch, once per Subtask, and offer to push and grow one draft merge/pull request once you say yes.
