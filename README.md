...
- **[setup-soron-skills](./skills/engineering/setup-soron-skills/SKILL.md)**: Configure this repo for Soron's workflow (GitLab, the DEV group's kanban board, single-context docs), with every org-wide answer already given. Run once per repo, in place of `setup-matt-pocock-skills`. Ships [WORKFLOW.md](./skills/engineering/setup-soron-skills/WORKFLOW.md), the guide to working the board.
...
- **[implement](./skills/engineering/implement/SKILL.md)**: Build the work described by a spec or a Deliverable's Subtasks on a branch and worktree of its own, driving `/tdd` at pre-agreed seams and closing out with `/code-review`, leaving the commit to `/land-the-work`.
